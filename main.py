...
arg_parser.add_argument(
    "-o", "--output-dir", default="./output/", type=str, help="Output directory"
)
arg_parser.add_argument(
    "-i", "--input", type=str, help="Input file or folder", required=True
)
arg_parser.add_argument(
    "-a", "--aspect-ratio", type=str, help="Aspect ratio of the background"
)
arg_parser.add_argument(
    "-t",
    "--type",
...
def main(args):
    ...
    for file in files:
        creator.generate(
            file, background_type=args.type, save=args.save, save_folder=args.output_dir
        )
